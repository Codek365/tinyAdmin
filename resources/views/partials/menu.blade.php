    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('user_zalo_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.user-zalos.index") }}" class="nav-link {{ request()->is('admin/user-zalos') || request()->is('admin/user-zalos/*') ? 'active' : '' }}">
                            <i class="fa-fw fas fa-cogs">

                            </i>
                            <p>
                                <span>{{ trans('cruds.userZalo.title') }}</span>
                            </p>
                        </a>
                    </li>
                @endcan
