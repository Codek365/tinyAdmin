    ...
    <div class="card-body">
        <form action="{{ route("admin.settings.update", [$setting->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('key') ? 'has-error' : '' }}">
                ...
                <input type="text" id="key" name="key" class="form-control" value="{{ old('key', isset($setting) ? $setting->key : '') }}">
                @if($errors->has('key'))
                    <p class="help-block">
                        {{ $errors->first('key') }}
                    </p>
            ...
            <div class="form-group {{ $errors->has('value') ? 'has-error' : '' }}">
                ...
                <input type="text" id="value" name="value" class="form-control" value="{{ old('value', isset($setting) ? $setting->value : '') }}">
                @if($errors->has('value'))
                    <p class="help-block">
                        {{ $errors->first('value') }}
                    </p>
